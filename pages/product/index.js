    ...
    getData() {
        if (this.id == 1) {
            return {
                ...
                components: "УРМ-1, РД-191М, стандартный головной обтекатель, бортовая система управления и навигации",
                model: "../../assets/models/Saturn V.glb",
            }
        }
        ...
        if (this.id == 2) {
            return {
                ...
                model: "../../assets/models/Space rocket.glb",
            }
        }
        ...
        if (this.id == 3) {
            return {
                ...
                model: "../../assets/models/Missile.glb",
            }
        }
    }
